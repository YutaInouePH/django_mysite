...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        ...
        whose published_at is in the future.
        """
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() returns False for questions whosepublished_at
        is older than 1 day.
        """
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() returns True for questions whosepublished_at
...
def create_question(question_text, days):
    ...
    negative for questions published in the past, positive for questiosn that have yet to be published.
    """
